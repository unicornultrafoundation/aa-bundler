...
export class DeterministicDeployer {
  ...
  static proxyAddress = process.env.DEPLOYER || '0x4e59b44847b379578588920ca78fbf26c0b4956c'
  static safeProxyAddress = '0x914d7fec6aac8cd542e72bca78b30650d45643d7'
  // Send tx with data = below and set contractAddress to env
  static deploymentBytecode = '604580600e600039806000f350fe7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe03601600081602082378035828234f58015156039578182fd5b8082525050506014600cf3';
  static deploymentTransaction = '0xf8a58085174876e800830186a08080b853' + DeterministicDeployer.deploymentBytecode + '1ba02222222222222222222222222222222222222222222222222222222222222222a02222222222222222222222222222222222222222222222222222222222222222'
